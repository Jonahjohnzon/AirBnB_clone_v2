...
class TestDBStorage(unittest.TestCase):
    """ Class test the database storage method """
    def test_new(self):
        """ New object correctly added to database """
        new = User(
    ...
    def test_delete(self):
        """ Object correctly deleted from database """
        new = User(
        ...
        result = cursor.fetchone()
        self.assertTrue(result is not None)
        self.assertIn('john20@gmail.com', result)
        self.assertIn('password', result)
        self.assertIn('Jonah', result)
